pipeline {
  ...
  environment {
    ...
    NAMESPACE = "@eeacms"
    SONARQUBE_TAGS = "volto.eea.europa.eu,climate-adapt.eea.europa.eu,land.copernicus.eu,water.europa.eu-freshwater,demo-www.eea.europa.eu,www.eea.europa.eu-en,climate-advisory-board.europa.eu,insitu.copernicus.eu,water.europa.eu-marine,biodiversity.europa.eu,forest.eea.europa.eu,industry.eea.europa.eu,ask.copernicus.eu,clmsdemo.devel6cph.eea.europa.eu"
    DEPENDENCIES = ""
